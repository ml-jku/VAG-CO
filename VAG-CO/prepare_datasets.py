...
RRG_datasets = ['RRG_100_k_=all', 'RRG_150_k_=all', "RRG_200_k_=all"]
dataset_choices = TU_datasets + RB_datasets + RRG_datasets + BA_datasets
parser = argparse.ArgumentParser()
parser.add_argument('--dataset', default='RRG_150_k_=all', choices = dataset_choices, help='Define the dataset')
parser.add_argument('--problem', default='MIS', choices = ["MIS", "MVC", "MaxCl", "MaxCut"], help='Define the CO problem')
parser.add_argument('--seed', default=[124, 125], type = int, help='Define dataset seed', nargs = "+")
parser.add_argument('--modes', default=["train", "val", "test"], type = str, help='Define dataset split', nargs = "+")
